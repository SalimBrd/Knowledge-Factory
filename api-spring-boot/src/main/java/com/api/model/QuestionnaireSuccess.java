...
public class QuestionnaireSuccess {
	...
	@JsonBackReference(value="user-questionnaireSuccess")
	@ManyToOne(fetch=FetchType.LAZY)
    @JoinColumn(foreignKey = @ForeignKey(name = "user_id"), name = "user_id")
    private User user;
	
	@JsonBackReference(value="questionnaire-questionnaireSuccess")
	@ManyToOne(fetch=FetchType.LAZY)
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		QuestionnaireSuccess other = (QuestionnaireSuccess) obj;
	...
	public String toString() {
		return "QuestionnaireSuccess [id=" + id + ", user=" + user + ", questionnaire=" + questionnaire
